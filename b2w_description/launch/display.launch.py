...
def generate_launch_description():
    ...
    urdf_path = PathJoinSubstitution(
        [FindPackageShare('b2w_description'), 'urdf', 'b2w_description.urdf']
    )
    ...
    robot_localization_launch_path = "/home/test/robot_ws/src/robot_localization/launch/unitree_b2w.launch.py"
