...
def generate_launch_description():
    #=============================1.定位到包的地址=============================================================
    buaacar_navigation2_dir = get_package_share_directory('buaacar_navigation2')
    ...
    nav2_param_path = LaunchConfiguration('params_file',default=os.path.join(buaacar_navigation2_dir,'param','unitree_b2w.yaml'))
    ...
    # return LaunchDescription([nav2_bringup_launch,map_odom_broadcaster_node,rviz_node])